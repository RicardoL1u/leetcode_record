...
func findMedianSortedArrays(nums1 []int, nums2 []int) float64 {
	...
	if (m+n)%2 == 1 {
		return binarySearch4(0, 0, m, n, k, nums1, nums2)
	} else {
		return (binarySearch4(0, 0, m, n, k-1, nums1, nums2) + binarySearch4(0, 0, m, n, k, nums1, nums2)) / 2
	}
...
func binarySearch4(s1, s2, e1, e2, k int, nums1, nums2 []int) float64 {
	var p1 int = (e1 + s1) / 2
	var p2 int = (e2 + s2) / 2
	// cnt ++
	// if cnt == 15 {
	...
	return binarySearch4(s1, s2, e1, e2, k, nums1, nums2)
